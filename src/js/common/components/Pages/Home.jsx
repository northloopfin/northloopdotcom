...
const Services = () => (
  <Container className={styles.servicesWrapper}>
    ...
    <div className={styles.maxWidthSec}>
        ...
        <h3>When you hand</h3>
        <p>100% secure (include attached fdic & visa logos) All accounts are insured up to $250,000 by the US government. </p>
      </div>
    </Grid>
    <Grid item xs={12} sm={4} className={styles.servicesRow}>
    <div className={styles.maxWidthThird}>
        <div className={styles.icon}><img src={FDIC} alt="Zero Fees" /></div>
        <h3>Bank Whenever You Are</h3>
        <p>Start the sign up process before you come to the US. Your card will be waiting for you</p>
      </div>
    </Grid>
  </Grid>
  </Container>
...
<Container>
    <Grid item container>
      <Grid item xs={12} sm={6}>
        <h3 className={styles.subtitle}>Great Credit Card With All Great Features <span /></h3>
        <p className={styles.discoverHow}>Discover How</p>
      </Grid>
